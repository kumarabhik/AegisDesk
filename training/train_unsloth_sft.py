...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", "--output", dest="output_dir", default="outputs/aegisdesk-sft")
    parser.add_argument("--hub-model-id", default=None)
    parser.add_argument("--push-to-hub", action="store_true")
    parser.add_argument("--report-to", default="none")
    parser.add_argument("--run-name", default="aegisdesk-qwen3-8b-sft")
    parser.add_argument("--max-seq-length", type=int, default=2048)
    parser.add_argument("--num-train-epochs", "--epochs", dest="num_train_epochs", type=float, default=1.5)
